...
First, make a copy of [this notebook](/eg/scripts/notebooks/ipynb/ABC/april_K562_59_genes.ipynb) on your computer / cluster.
...
```
    ...
    srun: job 25056244 queued and waiting for resources
