...
path_to_results = paste(work_dir, "ABC-Enhancer-Gene-Prediction/CRISPRi_FlowFISH/local_direct_evaluation_over_CRISPRi_FlowFISH/", sep='')
file_names = c("predictions_over_CRISPRi_FlowFISH.txt")
short_names = c('CRISPRi.FlowFISH')

nb_files = length(file_names)
colnames <- c('interaction', 'chr', 'start', 'end', 'ABC.Score', 'gene')
