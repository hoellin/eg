...
path_to_results = paste(work_dir, "ABC-Enhancer-Gene-Prediction/CRISPRi_FlowFISH/reference_k562/", sep='')
file_names = c("3863.fulco.tsv")
short_names = c('CRISPRi.FlowFISH')

nb_files = length(file_names)
colnames <- c('interaction', 'chr', 'start', 'end', 'Normalized.HiC.Contacts', 'Activity', 'ABC.Score')
