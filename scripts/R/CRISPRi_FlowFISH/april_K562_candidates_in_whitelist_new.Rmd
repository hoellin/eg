...
path_to_results = paste(work_dir, "ABC-Enhancer-Gene-Prediction/april_K562_candidates_in_whitelist/ABC_output/Predictions/", sep='')
file_names = c("predictions_intersected_with_CRISPRi_FlowFISH_regions_that_maximize_the_ABC_score.new.bedpe.sorted")
...
results <- sapply(file_names, simplify=FALSE, function(file_name){
  Df <- read.table(paste(path_to_results, as.character(file_name), sep=''), sep='\t', header=T)
